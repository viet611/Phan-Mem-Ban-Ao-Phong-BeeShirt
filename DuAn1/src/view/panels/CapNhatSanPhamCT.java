 ...
 * @author Admin
 */
public class CapNhatSanPhamCT extends javax.swing.JDialog {
...
//    }
    ...
    public ImageIcon ResizeImage(String ImagePath){
        ...
        Image newImage = image.getScaledInstance(lblAnhCN.getWidth(), lblAnhCN.getHeight(), Image.SCALE_SMOOTH);
    ...
    public void openEditDialogForm() {
        ...
        editDialogForm.setUpadateDialogForm(this);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(lblAnhCN, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblAnhCN, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
        );

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/icon/sanpham.png"))); // NOI18N
        jButton1.setText("Sua SP");
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatSanPhamCT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CapNhatSanPhamCT dialog = new CapNhatSanPhamCT();
