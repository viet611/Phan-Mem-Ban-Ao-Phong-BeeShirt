...
public class MucDichSuDung {
    ...
    public MucDichSuDung(int id, String ten, int trang_thai) {
        this.id = id;
        this.ten = ten;
        this.trang_thai = trang_thai;
    }

    public MucDichSuDung(int id, String ma, String ten, int trang_thai) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
        this.trang_thai = trang_thai;
    ...
    public MucDichSuDung(int id, String ma, String ten, int trang_thai, String tao_boi, String sua_boi, boolean da_xoa) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
        this.trang_thai = trang_thai;
    ...
    public MucDichSuDung(String ten) {
        this.ten = ten;
    }
    public int getId() {
        return id;
