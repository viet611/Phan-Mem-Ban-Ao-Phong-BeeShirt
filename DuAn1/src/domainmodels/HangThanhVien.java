...
public class HangThanhVien {
    ...
    public HangThanhVien(int id, int id_voucher, String ma, String ten, double so_tien_toi_thieu, int trangThai, Date ngay_tao, Date ngay_sua, String tao_boi, String sua_boi, Boolean da_xoa) {
        this.id = id;
