...
public class ChatLieu {
    ...
    public ChatLieu(int id, String ma, String ten, int trang_thai) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
    ...
    public ChatLieu(int id, String ma, String ten, int trang_thai, String tao_boi, String sua_boi, boolean da_xoa) {
        this.id = id;
        this.ma = ma;
        this.ten = ten;
        this.trang_thai = trang_thai;
